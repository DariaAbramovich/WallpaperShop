...
const ChatBot = ({language}) => {
  ...
  const handleBotResponse = (message) => {
    ...
    } else if (text.includes('где вы находитесь?') || text.includes('как до вас добраться') || text.includes('ваше местоположение')|| text.includes("как вас найти")) {
    ...
    } else if (text.includes('какие у вас есть обои?')|| text.includes('какие обои у вас можно купить')|| text.includes('что у вас можно купить')) {
    ...
    } else if (text.includes('информация о доставке') || text.includes('варианты доставки')|| text.includes('можно ли оформить доставку')) {
