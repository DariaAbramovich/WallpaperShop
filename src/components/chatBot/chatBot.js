...
//     },
//     // Добавьте переводы для остальных сообщений
//   };
...
//   //   if (responses[text]) {
//   //     // Проверяем, есть ли ответ на текущем языке
//   //     response = responses[text][currentLanguage];
//   //     if (!response) {
//   //       // Если ответа на текущем языке нет, выбираем другой язык
//   //       const otherLanguage = currentLanguage === 'ru' ? 'en' : 'ru';
//   //       response = responses[text][otherLanguage];
//   //     }
//   //   } else {
//   //     response = language === 'en' ? 'Sorry, I do not understand your request. Please clarify your question.' : 'Извините, я не понимаю ваш запрос. Пожалуйста, уточните ваш вопрос.';
//   //   }
