    ...
    import eyeIcon from './../../../assets/icon/yaeHide.png';
    import eyeOffIcon from './../../../assets/icon/yaeShow.png';
            ...
            <>
                <div className="reg-wrapper">
                    <form className="reg-form" onSubmit={handleSubmit}>
                        ...
                        <div className="reg-plase-input">
                            <div>
                                ...
                                <Tooltip anchorSelect="#info-name">
                                    <p>Имя должно состоять из русских или английских букв</p></Tooltip >
                        ...
                        <div className="reg-plase-input">
                            <div>
                                ...
                                <Tooltip anchorSelect="#info-email">
                                    <p>Почта должна быть вида: example@site.com</p>
                                </Tooltip>
                        ...
                        <div className="reg-plase-input">
                            <div>
                                ...
                                <Tooltip anchorSelect="#info-login">
                                    <p>Логин должен быть не менее 2 символов, может содержать в себе латинские буквы и цифры</p>
                                </Tooltip>
                        ...
                        <div className="reg-plase-input">
                            <div>
                                ...
                                <Tooltip anchorSelect="#info-pass">
                                    <p>Пароль должен содержать не менее 4 символов, среди которых могут быть латинские буквы и цифры</p>
                                </Tooltip>
                        ...
                        <div className="reg-btn-plase">
                            <button type="submit" className="reg-btn">Зарегистрироваться</button>
                        </div>
    
                        <div className="reg-link_login">
                            <span className='text-link-login '>Уже есть аккаунт?</span>
