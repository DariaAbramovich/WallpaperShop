            ...
            <div>
                ...
                <div className='InfoBlog_wrapper'>
                    <div class="hover-effect-btn">
                        ...
                        <div class="pr_button"><Link to='/nonWoven/'>Перейти</Link></div>
                    </div>
                    <div class="hover-effect-btn">
                        <div >
                        ...
                        <div class="pr_overlay"></div>
                        <div class="pr_button"><Link to='/vinil/'>Перейти</Link></div>
                    </div>
                    <div class="hover-effect-btn">
                        <div >
                        ...
                        <div class="pr_overlay"></div>
                        <div class="pr_button"><Link to='/paperwall/'>Перейти</Link></div>
                    </div>
                </div>
